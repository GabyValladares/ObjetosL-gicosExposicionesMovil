...
import static com.ggvc.practicaobjetoslogicosmoviliipa2023.R.id.ratingBar1;
import static com.ggvc.practicaobjetoslogicosmoviliipa2023.R.id.txt_cedula33;
import static com.ggvc.practicaobjetoslogicosmoviliipa2023.R.id.txt_contaminacion;
...
public class PropietarioVehiculo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_propietario_vehiculo);
        ...
        btnRegresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                View dialogView = LayoutInflater.from(PropietarioVehiculo.this).inflate(R.layout.dialogo_input, null);

                RatingBar ratingBar = dialogView.findViewById(R.id.ratingBar1);
                AlertDialog.Builder builder = new AlertDialog.Builder(PropietarioVehiculo.this);
                ...
                client.newCall(request).enqueue(new Callback() {
                    ...
                    public void onFailure(Call call, IOException e) {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(PropietarioVehiculo.this, "Error al enviar los datos", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(PropietarioVehiculo.this, "Datos enviados correctamente", Toast.LENGTH_SHORT).show();
                                }
                            });
                        } else {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(PropietarioVehiculo.this, "Error en la respuesta del servidor", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
    ...
    public void crearTablaVehiculo(){
        BDHelper admin=new BDHelper(this,"RegistroVehiculo.db",null,1);
        SQLiteDatabase bd=admin.getWritableDatabase();
        String cedula= String.valueOf(txtCedula);
        String nombre= String.valueOf(txtNombre);
        String apellido= String.valueOf(txt_contaminacion);
        String precio= String.valueOf(txtRenovacion);
        String marca= String.valueOf(txt_toalmatricula);
        String color= String.valueOf(txt_cedula33);
        String multas= String.valueOf(txtMultas);
        String año= String.valueOf(txt_toalmatricula);
